...
insert into ReklamationPosition (Reklamationnr, Artikelnr, Menge, Fehlerbeschr) values (101, 4704, 3, 'Controller bleiben stromlos.');
insert into ReklamationPosition (Reklamationnr, Artikelnr, Menge, Fehlerbeschr) values (101, 4703, 1, 'Pumpe schaltet nicht mehr ab.');
insert into ReklamationPosition (Reklamationnr, Artikelnr, Menge, Fehlerbeschr) values (102, 4700, 5, 'Motoren drehen schlecht an.');
insert into ReklamationPosition (Reklamationnr, Artikelnr, Menge, Fehlerbeschr) values (103, 4702, 1, 'Motor dreht deutlich zu langsam.');
insert into ReklamationPosition (Reklamationnr, Artikelnr, Menge, Fehlerbeschr) values (104, 4704, 2, 'Controller steuern nicht immer.');
commit;
